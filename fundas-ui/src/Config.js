...
export default {
    menus: [
        ...
        { text: 'Charts',
            ...
            icon: <Assessment/>,
            items: [
                    { text: 'Performance', link: 'performance/standalone' },
                    { text: 'Health', link: 'health/standalone' },
                    { text: 'Valuation', link: 'valuation/standalone' },
                    { text: 'Dividends', link: 'dividends/standalone'},
    ...
    keys: {
      ALL_COMPANIES: 'fundas_companies'
    },
